...
interface ILendingVault {
    ...
    function depositNative(uint256 assetAmt, uint256 minSharesAmt) external payable;
    ...
    function updateInterestRate(InterestRate calldata newInterestRate) external;
